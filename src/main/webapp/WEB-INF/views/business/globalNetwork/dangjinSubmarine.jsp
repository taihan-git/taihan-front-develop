			...
			<div class="global-detail">
				...
				<div class="inner-box">
					<p class="desc">
						...
						대한전선은 수십 년간 국내외 시장에서 쌓아온 네트워크와 기술력을 총 동원해, 당진해저케이블공장을 1단계, 2단계 나누어 조성하고 있습니다. 1단계에는 내부망에 주로 활용되는 케이블을 생산하고 2단계는 외부망 해저케이블과 생산할 계획입니다. 현재 1단계 건설을 완료하여 제품을 생산하고 있으며, 2단계도 2025년 제품 생산을 목표로 구축 중입니다.
					</p>
					...
					<ul class="list-summary">
						<li class="col">
							...
							<dl>
								<dt>설립연도</dt>
								<dd>
									<strong>1단계 2024년(준공완료)</strong>
									<strong>2단계 2025년(예정)</strong>
								</dd>
							</dl>
						</li>
						<li class="col">
						...
						<li class="col2">
							...
							<dl>
								<dt>생산품목</dt>
								<dd>
									<strong>1단계 내부망 해저케이블</strong>
									<strong>2단계 외부망 해저케이블</strong>
								</dd>
							</dl>
						</li>
					</ul>
		...
		<div class="content-box">
			<div class="inner-box">
				<div class="detail-wrap2" data-delighter>
					...
					<div class="img-flex">
						<img src="${CON_STATIC_URL}/asset/images/business/global_detail/cont06/submarine_img01.jpg">
					</div>
					<!-- 2022-12-26 -->
					<p class="text">
		...
		<div class="content-box">
			<div class="inner-box">
				<div class="detail-wrap2 right" data-delighter>
					...
					<div class="img-flex">
						<img src="${CON_STATIC_URL}/asset/images/business/global_detail/cont06/submarine_img02.jpg">
					</div>
					<p class="text">
		...
		<div class="content-box">
			<div class="inner-box">
				<div class="detail-wrap2 right" data-delighter>
					...
					<div class="img-flex">
						<img src="${CON_STATIC_URL}/asset/images/business/global_detail/cont06/submarine_img03.jpg">
					</div>
					<p class="text">
						...
						<div class="inner-box">
							...
							<ul class="list-summary">
								<li class="col">
									...
									<dl>
										<dt>Established</dt>
										<dd><strong>First Step : 2024 (Completed)</strong></dd>
										<dd><strong>Second Step : 2025 (Planned)</strong></dd>
									</dl>
								</li>
								<li class="col">
								...
								<li class="col2">
									...
									<dl>
										...
										<dd><strong>First Step : Inter Array Cable</strong></dd>
										<dd><strong>Second Step : Export Cable</strong></dd>
									</dl>
								</li>
							</ul>
						</div>
				...
				<div class="content-box">
					<div class="inner-box">
						<div class="detail-wrap2" data-delighter>
							...
							<div class="img-flex"><img src="${CON_STATIC_URL}/asset/images/business/global_detail/cont06/submarine_img01.jpg"></div>
							<p class="text">
				...
				<div class="content-box">
					<div class="inner-box">
						<div class="detail-wrap2 right" data-delighter>
							...
							<div class="img-flex"><img src="${CON_STATIC_URL}/asset/images/business/global_detail/cont06/submarine_img02.jpg"></div>
							<p class="text">
				...
				<div class="content-box">
					<div class="inner-box">
						<div class="detail-wrap2" data-delighter>
							...
							<div class="img-flex"><img src="${CON_STATIC_URL}/asset/images/business/global_detail/cont06/submarine_img03.jpg"></div>
							<p class="text">
