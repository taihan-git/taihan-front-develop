	...
	<div id="container" class="content-wrap">
		<div class="content-box">
			...
			<div class="global-detail">
				...
				<!-- 수정 -->
				<div class="inner-box">
					<p class="desc">충청남도 당진시 고대면에 위치한 당진공장은 대한전선 케이블 기술의 산실이자 핵심 생산 기지로, 세계 최대 규모와 효율을 자랑합니다. 초고압, 산업전선, 통신, 소재, 부스덕트 등 5개의 단위 공장과 기술연구소, PQ 시험장 등을 갖추고, 제품 개발부터 생산, 완제품 시험에 이르기까지 케이블 생산의 모든 공정을
							...
							<ul class="list-info">
								...
								<li>
									<dl>
										<dt>연락처</dt>
										<dd>
											<a href="tel:+82413609114">+82-41-360-9114</a>
										</dd>
									</dl>
								</li>
							</ul>
						...
						<div class="inner-box">
							...
							<ul class="list-summary">
								...
								<li>
									...
									<dl>
										<dt>Employees</dt>
										<dd><strong>430 employees</strong>(as of 2022)</dd>
									</dl>
								</li>
								<li>
