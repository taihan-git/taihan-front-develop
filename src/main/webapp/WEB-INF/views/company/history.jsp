								...
								<div class="inner-box">
									<div class="text">
										<h3>
											...
											<!-- 2022-12-26 -->
											<p>
												대한전선은 1980년대에 ‘제2의 창업’이라는 가치를 내걸고, <br>
											...
											<div>
												...
												<div class="box">
													...
													<ol>
														...
														<li>
															<strong>09</strong><span>Developed Korea's first ultra-low loss optical fiber</span>
														</li>
														<li>
															<strong>07</strong><span>Received the Order of Appreciation from the <br>Russian Federation Electricity Corporation (FSK)</span>
														</li>
														<li>
															<strong>07</strong><span>Developed Korea's first signal transmission cable<br> for train control</span>
														</li>
														<li>
